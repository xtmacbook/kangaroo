...
{
public:
	CubGeometry(const V3f& centerPos, float scale, IRenderMeshObj_SP);
};
...
LIBENIGHT_EXPORT IRenderNode_SP getCubRenderNode(const V3f& center = V3f(0.0, 0.0, 0.0), float scale = 1.0, bool update = false);
